...
mkdir -p ~/hw14/bin/clickstream_reduce_join/classes

javac -classpath /usr/hdp/2.6.4.0-91/hadoop/*:/usr/hdp/2.6.4.0-91/hadoop-mapreduce/* -d ~/hw14/bin/clickstream_reduce_join/classes ClickStreamReduceJoin.java

jar -cvf ~/hw14/bin/clickstream_reduce_join/clickstream_reduce_join.jar -C ~/hw14/bin/clickstream_reduce_join/classes/ .
